...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Frontend Developer 🚀 having an experience of building Web and Mobile applications with JavaScript / Reactjs / Wordpress / Storybook and some other cool libraries and frameworks."
  ),
  resumeLink:
    "https://drive.google.com/file/d/1ZsYla8msOvKZHYKwz4rSTIkTU9L-nVMR/view?usp=sharing", // Set to empty to hide the button
...
const skillsSection = {
  ...
  skills: [
    ...
    emoji(
      "⚡ Integration of third party libraries such as Storybook, Webpack and Redux"
    ),
    emoji("⚡ Develop websites with the most used CMS in all internet")
  ],
  ...
  projects: [
    {
      ...
      projectDesc:
        "The website seamlessly weaves together the tapestry of White Lodging’s attributes, spotlighting dozens of high-quality hotels and restaurants strewn across the United States. It’s not merely a virtual catalogue; it’s a visual journey that encapsulates the company’s services, rich history, and vibrant work culture.",
      footerLink: [
        {
          name: "Visit Website",
